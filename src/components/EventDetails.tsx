    ...
    <section id="details" className={`${styles.details} reveal ${isVisible ? 'visible' : ''}`} ref={domRef}>
      ...
      <div className={styles.grid}>
        <div className={styles.card}>
          <h3>Akad Nikah</h3>
          <p className={styles.time}><Clock size={16} /> 08:00 - 10:00 WIB</p>
          <p className={styles.venue}><MapPin size={16} /> Masjid Raya Al-Ikhlas</p>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.time}><Clock size={16} /> 11:00 - 14:00 WIB</p>
          <p className={styles.venue}><MapPin size={16} /> Gedung Serbaguna As-Salam</p>
